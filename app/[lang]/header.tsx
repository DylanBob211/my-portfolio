...
export default function Header({ dict }: { dict: Dictionary }) {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-gradient-to-b from-white via-white/90 via-80% to-transparent pt-6 pb-10 dark:from-black dark:via-black/70">
