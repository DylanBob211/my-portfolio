...
>(function Mb(
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.99 }}
      className="relative h-10 overflow-hidden rounded border border-gray-400 bg-transparent/50 p-2 transition ease-in-out focus:ring-1 focus:ring-gray-700 focus:outline-none dark:border-gray-100"
      {...props}
    >
      ...
      <form action={dispatch} className="flex flex-col gap-4">
        <label className="flex flex-col">
          ...
          <input
            ...
            name="name"
            required
            className="rounded border border-gray-400 bg-transparent/50 p-2 transition ease-in-out focus:ring-1 focus:ring-gray-700 focus:outline-none dark:border-gray-100"
